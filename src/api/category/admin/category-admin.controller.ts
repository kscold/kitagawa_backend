...
import { ApiTags, ApiOperation, ApiResponse as SwaggerResponse, ApiParam, ApiBearerAuth, ApiBody, ApiQuery } from '@nestjs/swagger';
...
export class CategoryAdminController {
    ...
    @ApiOperation({
        ...
        description: 'ID로 카테고리 상세 정보를 조회합니다 (비활성화 카테고리 포함)',
    })
    ...
    async findById(@Param('id') id: string) {
        return {
            ...
            code: HttpStatus.OK,
            message: '카테고리 조회 성공',
            data: await this.categoryAdminService.findById(id),
        };
    }
    ...
    async update(@Param('id') id: string, @Body() categoryData: UpdateCategoryRequestDto) {
        return {
            success: true,
            code: HttpStatus.OK,
            message: '카테고리가 수정되었습니다',
            data: await this.categoryAdminService.update(id, categoryData),
        };
    }
    ...
    async deactivate(@Param('id') id: string) {
        return {
            ...
            data: await this.categoryAdminService.deactivate(id),
        };
    }
    ...
    async activate(@Param('id') id: string) {
        return {
            ...
            data: await this.categoryAdminService.activate(id),
        };
    }
    ...
    async updateOrder(@Param('id') id: string, @Body() orderData: UpdateCategoryOrderRequestDto) {
        return {
            success: true,
            code: HttpStatus.OK,
            message: '카테고리 순서가 변경되었습니다',
            data: await this.categoryAdminService.updateOrder(id, orderData.order),
        };
    }
}
